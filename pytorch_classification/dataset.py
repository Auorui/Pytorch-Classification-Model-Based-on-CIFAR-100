...
def get_train_loader_cifar100(mean, std, batch_size=16, num_workers=2, shuffle=True):
...
def get_val_loader_cifar100(mean, std, batch_size=16, num_workers=2, shuffle=True):
